...
#
# Reverts every runtime change made by issue53-winpe-phase2-setup-run.sh
...
#
# Issue #53 Phase 2: probes whether the stock Microsoft-signed
# EFI/Boot/bootx64.efi is accepted and executed under the same physical
# Secure Boot state validated in Phase 1 (diskless, Secure Boot
# Enabled/Active/Standard, factory keys restored). See
# issue53-winpe-phase2-setup-run.sh for the full context and artifact
# provenance.
...
echo "== Bamep Issue #53 Phase 2 - CLEANUP =="
