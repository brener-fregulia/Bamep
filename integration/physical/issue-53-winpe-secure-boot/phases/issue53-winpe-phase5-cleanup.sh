...
#
# Reverts every runtime change made by issue53-winpe-phase5-setup-run.sh
...
#
# Issue #53 Phase 5: probes whether serving bootmgfw.efi bytes (extracted
# from boot.wim) at the literal path EFI/Boot/bootx64.efi changes the
# physical Windows network-boot behavior under Secure Boot, compared to
# Phase 3's stock media bootx64.efi (diskless, Secure Boot
# Enabled/Active/Standard, factory keys restored). See
# issue53-winpe-phase5-setup-run.sh for the full context and artifact
# provenance.
...
echo "== Bamep Issue #53 Phase 5 - CLEANUP =="
