//! Embeds build-identity metadata the probe prints on startup. No external
//! crates; values come from the environment Cargo/rustc already expose plus a
//! wall-clock stamp. (Copied from the CP6 probe build script; CP7A is a
