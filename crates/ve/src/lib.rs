...
pub use network::{
    ...
    bare_boot_ipxe_script, bridged_forward_accommodation_rules, bve_run_dir,
    ...
    prepare as prepare_network, remove_bridged_forward_accommodation,
    remove_dhcp_forward_accommodation, residual_resources, teardown as teardown_network,
    winpe_boot_ipxe_script, winpe_fixture_dnsmasq_argv, winpe_http_base_url,
    winpe_http_fixture_command, winpe_http_root, winpe_tftp_root, BveNetworkError, BveNetworkPlan,
    NetResource, NetResourceKind, PreparedBveNetwork, BARE_PXE_INITRD_NAME, BARE_PXE_KERNEL_NAME,
